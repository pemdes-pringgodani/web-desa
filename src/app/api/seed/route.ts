  ...
  try {
    ...
    const news1 = await prisma.news.create({
      data: {
        ...
        excerpt: "Kegiatan ini merupakan tasyakuran memperingati 17 Agustus yang menjadi kegiatan rutin di hari kemerdekaan desa Pringgodani. Tasyakuran ini di hadiri oleh masyarakat desa Pringgodani, tokoh tokoh agama serta Peserta KKN Universitas Kanjuruhan Malang. Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news2 = await prisma.news.create({
      data: {
        ...
        excerpt: "Pemasangan papan 10 Program Pokok PPK merupakan salah satu dari program kerja kelompok 3 desa Pringgodani. Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news3 = await prisma.news.create({
      data: {
        ...
        excerpt: "Posyandu Lansia merupakan rutin yang dilaksanakan oleh Desa Pringgodani yaitu pemeriksaan kesehatan para lansia... Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news4 = await prisma.news.create({
      data: {
        ...
        excerpt: "Penyuluhan pentingnya pendidikan merupakan suatu program yang dilaksanakan untuk memotivasi dan memberikan wawasan siswa dan siswi Mts Bustanul Qura'ni Al Ihsani... Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news5 = await prisma.news.create({
      data: {
        ...
        excerpt: "Lomba Voly ini diadakan oleh desa Pringgodani yang dibuka pada tanggal 21 Juli 2017 pukul 20.30 WIB untuk memperingati HUT RI ke 72 th... Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news6 = await prisma.news.create({
      data: {
        ...
        excerpt: "Penyuluhan Imunisasi Campak dan Rubella oleh Puskesmas Wonokerto dilaksanakan Jumat, 21 Juli 2017 sekitar pukul 09.00... Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news7 = await prisma.news.create({
      data: {
        ...
        excerpt: "Bimbingan belajar ini merupakan salah satu kegiatan yang diselenggarakan oleh kelompok 3 dikediaman ibu Sumrati... Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    const news8 = await prisma.news.create({
      data: {
        ...
        excerpt: "Penyuluhan Pentingnya Kesehatan Gigi di SDN pringgodani 01 merupakan program kerja yang dilaksanakan oleh kelompok 3... Penulis: adminpringgondani.",
        status: "PUBLISHED",
    ...
    // Artikel 9: First Blog Post / Pengenalan Portal (Author: sellyprasticca, Category: Uncategorized)
    ...
    console.log("✅ Seeding Web Desa Pringgodani via Next.js API Route Finished Successfully!");
    return NextResponse.json({
      success: true,
      message: "Database seeding with real WordPress data completed successfully!",
    });
  } catch (error) {
    console.error("❌ Seeding Error:", error);
    return NextResponse.json(
      { success: false, error: String(error), details: error },
      { status: 500 }
    );
  }
}
